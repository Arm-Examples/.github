...
On microcontrollers, serial I/O messages (printf-style output) can be sent to a host PC in several common ways. The most widely used are Semihosting, UART, and RTT. Each method has different trade-offs in terms of speed, intrusiveness, hardware requirements, and suitability for production code.
